    ...
    actions = [
        ...
        Node(
            ...
            arguments=[
                ...
                "-z", spawn_z,
                # Spawn in lying pose (zero_offset per joint) so physics doesn't
                # flip the robot before the position controller takes over.
                "-J", "FR_hip_joint",   "0.105",
                "-J", "FR_thigh_joint", "1.08",
                "-J", "FR_calf_joint",  "-2.7",
                "-J", "FL_hip_joint",   "0.105",
                "-J", "FL_thigh_joint", "1.08",
                "-J", "FL_calf_joint",  "-2.7",
                "-J", "RR_hip_joint",   "0.105",
                "-J", "RR_thigh_joint", "1.08",
                "-J", "RR_calf_joint",  "-2.7",
                "-J", "RL_hip_joint",   "0.105",
                "-J", "RL_thigh_joint", "1.08",
                "-J", "RL_calf_joint",  "-2.7",
            ],
            output="screen",
        ),
