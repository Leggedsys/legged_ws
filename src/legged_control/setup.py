...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "teleop_node           = legged_control.real2sim.teleop_node:main",
            "urdf_joint_state_bridge = legged_control.real2sim.urdf_joint_state_bridge:main",
            "gazebo_control_bridge = legged_control.gazebo_control_bridge:main",
            "state_estimator_node  = legged_control.real2sim.state_estimator_node:main",
            "height_scan_node      = legged_control.real2sim.height_scan_node:main",
            "policy_node           = legged_control.policy_node:main",
            "policy_node_sim       = legged_control.policy_node_sim:main",
        ],
    },
)
